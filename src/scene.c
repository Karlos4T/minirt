...
/*   Updated: 2024/06/06 23:12:02 by dximenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_scene	*initialize_scene()
{
	...
	scene->light = create_light(c_vec(500, 0, -700), 1, 0x00FFFFFF);


	scene->obj = malloc(sizeof(t_objects));

	scene->obj->cyl = malloc(sizeof(t_cylinder) * 2);
	...
	scene->obj->sph = malloc(sizeof(t_sphere) * 5);
	...
	scene->obj->pla = malloc(sizeof(t_plane) * 3);
